...
// normalizacion
// author
var authorSchema = new _normalizr.schema.Entity("authors", {}, { idAtribute: "email" });

// mensajes
var menssageSchema = new _normalizr.schema.Entity("messages", { author: authorSchema });
...
var normalizarData = function normalizarData(data) {
  var normalizeData = (0, _normalizr.normalize)({ id: "chat", messages: data }, chatSchema);
...
app.get("/tienda", function (req, res) {
  ...
  if (req.isAuthenticated()) {
    ...
    res.send("<div>Debes <a href='/inicio'>inciar sesion</a> o <a href='/registro'>registrarte</a></div>");
  }
});
...
if (MODO === "CLUSTER" && _cluster2.default.isPrimary) {
  ...
  io.on("connection", function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(socket) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 3:
              ...
              _context4.t0.emit.call(_context4.t0, "products", _context4.t1);
            ...
            case 9:
              ...
              _context4.t2.emit.call(_context4.t2, "messages", _context4.t3);

              //recibimos el mensaje del usuario y lo guardamos en el archivo chat.txt
              socket.on("newMessage", function () {
                var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(newMsg) {
                    ...
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        ...
                        case 5:
                          ...
                          _context3.t0.emit.call(_context3.t0, "messages", _context3.t1);
